                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {bookings.map((booking) => (
                                <div key={booking._id} className="p-5 rounded-xl shadow-md border bg-white">
                                    ...
                                    <p className="text-gray-700"><span className="font-semibold">Category:</span> {booking.category.join(", ")}</p>
                                    <p className="text-gray-700"><span className="font-semibold">Class:</span> {booking.className}</p>
                                    <p className="text-gray-700"><span className="font-semibold">Seats:</span> {booking.seatNumber.join(", ")}</p>
