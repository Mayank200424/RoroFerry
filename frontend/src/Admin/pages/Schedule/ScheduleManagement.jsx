...
const ScheduleManagement = () => {
    ...
    useEffect(() => {
        const fetchSchedules = async () => {
            try {
                const response = await axios.get("http://localhost:5000/api/get-schedules");
    ...
    const handleSave = async () => {
        ...
        const updatedFields = {
            ...
            onwardStatus: selectedSchedule.onwardStatus,
            returnStatus: selectedSchedule.returnStatus,
